 ...
 */
final class Version20230313133112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE find (id INT AUTO_INCREMENT NOT NULL, plant_id INT DEFAULT NULL, user_id INT NOT NULL, url LONGTEXT DEFAULT NULL, latitude LONGTEXT DEFAULT NULL, longitude LONGTEXT DEFAULT NULL, date DATE DEFAULT NULL, INDEX IDX_C9AE64041D935652 (plant_id), INDEX IDX_C9AE6404A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
